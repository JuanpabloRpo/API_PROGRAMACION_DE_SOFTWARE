namespace API_PROGRAMACION_DE_SOFTWARE.Queries
{
    public class ReservationQueries
    {
        ...
        public static string checkReservationPending = @"SELECT * FROM Reservations WHERE ReservationId = @ReservationId AND Status = 0";
        public static string updateReservationStatus = @"UPDATE Reservations SET Status = @Status WHERE ReservationId = @ReservationId";
